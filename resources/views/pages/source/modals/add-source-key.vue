...
<template>
    ...
    <Dialog size="lg">
        ...
        <div class="grid grid-cols-1 gap-6 border-t px-6 py-4 md:grid-cols-2">
            ...
            <BaseButton @click="submit" variant="primary" type="button" size="lg" :disabled="!form.languages.length || form.processing" :is-loading="form.processing"> Save & Add Next </BaseButton>
        </div>
    </Dialog>
</template>
