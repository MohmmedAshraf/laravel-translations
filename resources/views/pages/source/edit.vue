    ...
    <LayoutDashboard>
        <div class="w-full bg-white shadow">
            <div class="mx-auto flex w-full max-w-7xl items-center justify-between px-6 lg:px-8">
                ...
                <Link v-tooltip="trans('Go back')" :href="route('ltu.source_translation')"
                    ...
                    <div class="flex w-full items-center justify-center gap-4 border-t border-blue-200 px-4 py-1.5">
                        <div class="flex w-full items-center">
                            <span class="text-xs text-gray-400">
                                {{ trans('Characters Length') }}: {{ form.phrase.length }}
                            </span>
                        </div>

                        <button v-tooltip="langCode ? trans('Speak') : trans('Language not supported')"
                ...
                <div class="w-full overflow-hidden rounded-md bg-white shadow ring-2 ring-blue-100">
                    <div class="flex min-h-[231px] flex-col p-4">
                        ...
                        <div class="mt-4 w-full space-y-1">
                            <InputLabel for="note" :value="trans('Translation note')" />

                            <InputTextarea id="note" v-model="form.note" size="md" rows="3" class="resize-none"
                                :error="form.errors.note" :placeholder="trans('Add a note to this translation')" />
                    ...
                    <div class="grid grid-cols-2 border-t border-blue-200">
                        ...
                        <BaseButton :is-loading="form.processing" variant="primary"
                            class="items-center rounded-none py-4 !text-sm !font-medium uppercase" @click="submit">
