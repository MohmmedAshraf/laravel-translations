    ...
    <div class="w-full hover:bg-gray-100">
        <div class="flex h-14 w-full divide-x">
            ...
            <div class="flex w-full items-center justify-start px-4">
                <div
                    class="truncate rounded-md border bg-white px-1.5 py-0.5 text-sm font-medium text-gray-600 hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600">
                    {{ phrase.key }}
                </div>
            </div>
            ...
            <div class="grid w-36 grid-cols-2 divide-x">
                <Link v-tooltip="trans('Edit')" :href="route('ltu.source_translation.edit', phrase.uuid)"
            ...
            <ConfirmationDialog size="sm" :show="showDialog">
                <div class="flex flex-col p-6">
                    ...
                    <span class="mt-2 text-sm text-gray-500">
                        {{ trans('This action cannot be undone, This will permanently delete the selected languages and'
                    ...
                    <div class="mt-4 flex gap-4">
                        ...
                        <BaseButton variant="danger" type="button" size="lg" :is-loading="loading" full-width
                            @click="deletePhrase(phrase.uuid)"> {{ trans('Delete') }} </BaseButton>
                    </div>
                </div>
            </ConfirmationDialog>
        </div>
